...
const songs = [
  ...
  },
  {
    id: '14',
    songName: 'Naina',
    subtitle: 'Diljit Dosanjk',
    poster: 'img/14.jpg',
  },
  {
    id: '15',
    songName: 'Nashe Se Chad Gayi',
    subtitle: 'Arijit Singh',
    poster: 'img/15.jpg',
  },
  {
  ...
  {
    id: '17',
    songName: ' Psyco Saiyaan ',
    subtitle: 'Sanchet Tadon',
    poster: 'img/17.jpg',
  },
  {
    id: '18',
...
Array.from(document.getElementsByClassName('songItem')).forEach((e, i) => {
  ...
  e.getElementsByTagName('h5')[0].innerHTML = `${songs[i].songName}<br><div class="subtitle">${songs[i].subtitle}</div>`;
});
...
songs.forEach(element => {
  ...
  card.addEventListener('mouseenter', () => {
    let audioElem = card.querySelector('audio');
    audioElem.currentTime = 0;
    audioElem.play();
  });

  // Optional: pause when mouse leaves
...
songs.forEach(element => {
  ...
  // Update master play button and wave
  ...
  // Update title and download name
  ...
  // Highlight selected song in main list
  makeAllBackground();
  ...
  // Update play icon if exists in playlist
  let playIcon = document.getElementById(index);
  if (playIcon) {
